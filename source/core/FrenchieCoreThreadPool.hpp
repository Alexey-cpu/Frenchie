    ...
    namespace Core
    {
        namespace Thread
        {
            ...
            public:
                ...
                decltype(auto) enqueue(F&& f, Arguments&&... args);
                ~Pool();
            ...
            inline Pool::Pool(size_t threads)
            {
            ...
            template <typename F, typename... Arguments>
            decltype(auto) Pool::enqueue(F&& f, Arguments&&... args)
            {
        ...
        typedef Singleton<Thread::Pool> TreadPool;
