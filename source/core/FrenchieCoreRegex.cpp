...
std::wstring Frenchie::Core::Regex::substring(const std::wstring& _Origin, const Frenchie::Core::Regex::Match& _Match)
{
    return std::wstring(&_Origin[_Match.Start], &_Origin[_Match.Finish]);
}