...
//         auto asyncProcessQueue = Frenchie::Application::ThreadQueue::instance();
...
//             {
//                 auto status   = std::dynamic_pointer_cast<IThreadStatus>(process);
//                 auto progress = std::dynamic_pointer_cast<IThreadProgress>(process);
