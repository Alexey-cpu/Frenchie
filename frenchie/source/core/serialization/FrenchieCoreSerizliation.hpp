    ...
    namespace Core
    {
        namespace Serizliation
        {
            ...
            */
            ...
            class ElementNameProcessor
            {
            public:
                template<typename Callback>
                static void normalize(const char* _Input, const int& _Size, const Callback& _Callback)
                {
            ...
            public:
                ...
                static bool is_string(const char* _Begin, const int& _Size)
                {
                    return _Begin != nullptr && _Size >= 2 && _Begin[0] == '"' && _Begin[_Size - 1] == '"';
                }

                static bool is_bool(const char* _Begin, const int& _Size)
                {
                    return _Begin != nullptr && (!strncmp("true", _Begin, _Size) || !strncmp("false", _Begin, _Size));
                }

                static bool is_null(const char* _Begin, const int& _Size)
                {
                    return _Begin != nullptr && !strncmp("null", _Begin, _Size);
                }

                static bool is_decimal_number(const char* _Begin, const int& _Size)
                {
