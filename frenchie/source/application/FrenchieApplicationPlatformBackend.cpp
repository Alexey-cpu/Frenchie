...
{
    return ApplicationPlatformBackend::on_awake();
}

void ApplicationPlatformBackend::frame_start()
{
    ApplicationPlatformBackend::on_frame_start();
...
{
    ApplicationPlatformBackend::on_frame_update();
}

void ApplicationPlatformBackend::frame_finish()
{
    ApplicationPlatformBackend::on_frame_finish();
...
{
    ApplicationPlatformBackend::on_quit();
}