...
{
    return  gs_matrix_translate(gs_vec3f(_Position.x, _Position.y, Frenchie::Application::ApplicationRenderingBackend::calculate_object_depth(_Position.z))) *
            gs_matrix_rotate(gs_to_radians(_Rotation), gs_vec3f(0.f, 0.f, 1.f)) * 
            gs_matrix_scale(gs_vec3f(_Scale, 1.f));
}
