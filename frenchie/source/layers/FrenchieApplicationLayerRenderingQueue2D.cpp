...
void RenderingQueue2D::push_rectangle_gradient_mesh(
    const gs_vec2f& _Min,
    const gs_vec2f& _Max,
...
void RenderingQueue2D::push_rectangle_rounded_filled(
    const gs_vec2f& _Min,
    const gs_vec2f& _Max,
    const float&    _Radius,
    const gs_color& _Color,
...
void RenderingQueue2D::push_line(
    const gs_vec2f& _P1,
    const gs_vec2f& _P2,
    const float&    _Width,
    const gs_color& _Color,
...
void RenderingQueue2D::push_rectangle(
    const gs_vec2f& _Min,
    const gs_vec2f& _Max,
    const float&    _Width,
    const gs_color& _Color,
...
void RenderingQueue2D::push_rectangle_rounded(
    const gs_vec2f& _Min,
    const gs_vec2f& _Max,
    const float&    _Radius,
    const float&    _Width,
...
void RenderingQueue2D::build_triangle_filled_mesh(
    const gs_vec2f&                           _P1,
    const gs_vec2f&                           _P2,
    const gs_vec2f&                           _P3,
    const gs_color&                           _Color,
...
void RenderingQueue2D::build_triangle_gradient_mesh(
    const gs_vec2f& _P1,
    const gs_vec2f& _P2,
    const gs_vec2f& _P3,
    const gs_color& _Color1,
...
void RenderingQueue2D::build_rectangle_filled_mesh(
    const gs_vec2f&                           _Min,
    const gs_vec2f&                           _Max,
    const gs_color&                           _Color,
    const ApplicationRenderingBackendTexture& _Texture)
...
void RenderingQueue2D::build_rectangle_gradient_mesh(
    const gs_vec2f& _Min,
    const gs_vec2f& _Max,
    const gs_color& _Color1,
    const gs_color& _Color2,
...
void RenderingQueue2D::build_line_mesh(
    const gs_vec2f&                           _P1,
    const gs_vec2f&                           _P2,
    const float&                              _Width,
    const gs_color&                           _Color,
