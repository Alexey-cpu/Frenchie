    ...
    namespace Application
    {
        namespace Configuration
        {
            ...
            protected:
                ...
                // constants
                inline static const std::string TRANSLATION_FILE_LOAD_NAME = "Load translation file...";
                inline static const std::string TRANSLATION_FILE_SAVE_NAME = "Save translation file...";
            };
